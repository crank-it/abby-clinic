...
export default function ContactPage() {
  const robots = [
    { src: '/new-server.png', position: 'left-top', className: 'hidden md:block -left-16 top-20 w-32 h-32 -rotate-12' },
    { src: '/hiw2.png', position: 'right-top', className: 'hidden md:block -right-14 top-32 w-28 h-28 rotate-12' },
    { src: '/new-server.png', position: 'left-bottom', className: 'hidden md:block -left-12 bottom-40 w-28 h-28 rotate-6' },
